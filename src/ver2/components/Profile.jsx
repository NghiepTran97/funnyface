...
export default function Profile() {
  ...
  return (
    <div className="bg-[#323232] h-full container wrapper-body m-0">
      {notiImage.status ? (
        <>
        ...
        <div className="line border-[#C6C6C6]">
          <div className="flex mt-12 container wrapper">
            <div className="flex-1 w-full text-center">
              <h1 className="lg:text-5xl lg:my-3 lg:max-w-[180px] text-white max-lg:my-2 max-lg:text-3xl pl-4">
                @{data.user_name}
              </h1>
            </div>
            <div className="flex">
